...
function ControlPanel() {
  ...
  return (
    <div className="control-panel">
       <Card className='mb-2'>
            <p className='lead pt-3 text-start mx-3 mt-2'>Sections <Button variant='outline-dark' className='float-end mx-2' bsSize='small'>X</Button></p>
        ...
        <Accordion className='mb-2 bg-light'>
            <Accordion.Item eventKey="0">
                <Accordion.Header className='accordion_header'>Sections</Accordion.Header>
                <Accordion.Body>
                    <Card className='mb-2'>
